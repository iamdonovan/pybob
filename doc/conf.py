...
autodoc_mock_imports = ['numpy', 'scipy', 'matplotlib', 'fiona', 'cv2', 'pyvips', 'xml.etree.ElementTree',
...
latex_documents = [
    (master_doc, 'pybob.tex', 'pybob Documentation',
...
man_pages = [
    (master_doc, 'pybob', 'pybob Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pybob', 'pybob Documentation',
     author, 'pybob', 'One line description of project.',
     'Miscellaneous'),
]
